...
public protocol YrsDocProtocol : AnyObject {
    ...
    func observeUpdateV1(delegate: YrsUpdateObservationDelegate)  -> YSubscription
...
open func observeUpdateV1(delegate: YrsUpdateObservationDelegate) -> YSubscription {
    return try!  FfiConverterTypeYSubscription.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsdoc_observe_update_v1(self.uniffiClonePointer(),
        FfiConverterCallbackInterfaceYrsUpdateObservationDelegate.lower(delegate),$0
    )
})
}
...
open func jsonPath(path: String)throws  -> [String] {
    return try  FfiConverterSequenceString.lift(try rustCallWithError(FfiConverterTypeYrsJsonPathError.lift) {
 ...
 */
public struct YrsUpdateEvent {
    public var update: [UInt8]

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(update: [UInt8]) {
        self.update = update
    }
}
...
extension YrsUpdateEvent: Equatable, Hashable {
    public static func ==(lhs: YrsUpdateEvent, rhs: YrsUpdateEvent) -> Bool {
...
public struct FfiConverterTypeYrsUpdateEvent: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> YrsUpdateEvent {
        return
            try YrsUpdateEvent(
                update: FfiConverterSequenceUInt8.read(from: &buf)
        )
    }

    public static func write(_ value: YrsUpdateEvent, into buf: inout [UInt8]) {
        FfiConverterSequenceUInt8.write(value.update, into: &buf)
    }
}


public func FfiConverterTypeYrsUpdateEvent_lift(_ buf: RustBuffer) throws -> YrsUpdateEvent {
    return try FfiConverterTypeYrsUpdateEvent.lift(buf)
}

public func FfiConverterTypeYrsUpdateEvent_lower(_ value: YrsUpdateEvent) -> RustBuffer {
    return FfiConverterTypeYrsUpdateEvent.lower(value)
}
...
public struct FfiConverterTypeYrsDiff: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> YrsDiff {
        ...
        case 1: return .text(value: try FfiConverterString.read(from: &buf), attrs: try FfiConverterString.read(from: &buf)
        )
        
        case 2: return .embed(value: try FfiConverterString.read(from: &buf), attrs: try FfiConverterString.read(from: &buf)
        )
        
        case 3: return .other(attrs: try FfiConverterString.read(from: &buf)
        )
...
// Put the implementation in a struct so we don't pollute the top-level namespace
fileprivate struct UniffiCallbackInterfaceYrsDestroyObservationDelegate {

    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceYrsDestroyObservationDelegate = UniffiVTableCallbackInterfaceYrsDestroyObservationDelegate(
        call: { (
            uniffiHandle: UInt64,
            uniffiOutReturn: UnsafeMutableRawPointer,
            uniffiCallStatus: UnsafeMutablePointer<RustCallStatus>
...
// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceYrsDestroyObservationDelegate {
...
// Put the implementation in a struct so we don't pollute the top-level namespace
fileprivate struct UniffiCallbackInterfaceYrsSubdocsObservationDelegate {

    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceYrsSubdocsObservationDelegate = UniffiVTableCallbackInterfaceYrsSubdocsObservationDelegate(
        call: { (
            uniffiHandle: UInt64,
            event: RustBuffer,
            uniffiOutReturn: UnsafeMutableRawPointer,
            ...
            let makeCall = {
                ...
                return uniffiObj.call(
                     event: try FfiConverterTypeYrsSubdocsEvent.lift(event)
                )
            }
...
// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceYrsSubdocsObservationDelegate {
 ...
 */
public protocol YrsUpdateObservationDelegate : AnyObject {
...
// Put the implementation in a struct so we don't pollute the top-level namespace
fileprivate struct UniffiCallbackInterfaceYrsUpdateObservationDelegate {

    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceYrsUpdateObservationDelegate = UniffiVTableCallbackInterfaceYrsUpdateObservationDelegate(
        call: { (
            uniffiHandle: UInt64,
            event: RustBuffer,
            uniffiOutReturn: UnsafeMutableRawPointer,
            ...
            let makeCall = {
                () throws -> () in
                guard let uniffiObj = try? FfiConverterCallbackInterfaceYrsUpdateObservationDelegate.handleMap.get(handle: uniffiHandle) else {
                    throw UniffiInternalError.unexpectedStaleHandle
                }
                return uniffiObj.call(
                     event: try FfiConverterTypeYrsUpdateEvent.lift(event)
                )
            }
        ...
        uniffiFree: { (uniffiHandle: UInt64) -> () in
            let result = try? FfiConverterCallbackInterfaceYrsUpdateObservationDelegate.handleMap.remove(handle: uniffiHandle)
            if result == nil {
                print("Uniffi callback interface YrsUpdateObservationDelegate: handle missing in uniffiFree")
            }
        }
    )
}

private func uniffiCallbackInitYrsUpdateObservationDelegate() {
    uniffi_uniffi_yniffi_fn_init_callback_vtable_yrsupdateobservationdelegate(&UniffiCallbackInterfaceYrsUpdateObservationDelegate.vtable)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceYrsUpdateObservationDelegate {
    fileprivate static var handleMap = UniffiHandleMap<YrsUpdateObservationDelegate>()
}

extension FfiConverterCallbackInterfaceYrsUpdateObservationDelegate : FfiConverter {
    typealias SwiftType = YrsUpdateObservationDelegate
    typealias FfiType = UInt64
...
fileprivate struct FfiConverterOptionTypeYrsDoc: FfiConverterRustBuffer {
    typealias SwiftType = YrsDoc?
...
fileprivate struct FfiConverterSequenceTypeYrsDoc: FfiConverterRustBuffer {
    typealias SwiftType = [YrsDoc]
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [YrsDoc] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeYrsDoc.read(from: &buf))
        }
        return seq
    }
}
...
fileprivate struct FfiConverterSequenceTypeYrsDiff: FfiConverterRustBuffer {
    typealias SwiftType = [YrsDiff]
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [YrsDiff] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeYrsDiff.read(from: &buf))
        }
        return seq
    }
}
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_uniffi_yniffi_checksum_method_yrsdoc_observe_update_v1() != 43756) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_uniffi_yniffi_checksum_method_yrsupdateobservationdelegate_call() != 28550) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    uniffiCallbackInitYrsUpdateObservationDelegate()
